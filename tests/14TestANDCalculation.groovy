...
assertEquals("T", selenium.getText("xpath=(.//*[normalize-space(text()) and normalize-space(.)='F'])[24]/following::td[1]"));
assertEquals("T", selenium.getText("xpath=(.//*[normalize-space(text()) and normalize-space(.)='T'])[19]/following::td[1]"));
assertEquals("T", selenium.getText("xpath=(.//*[normalize-space(text()) and normalize-space(.)='T'])[20]/following::td[1]"));
assertEquals("T", selenium.getText("xpath=(.//*[normalize-space(text()) and normalize-space(.)='T'])[21]/following::td[1]"));
